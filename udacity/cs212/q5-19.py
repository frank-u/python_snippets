...
def Pwin(state):
    ...
    if me + pending >= goal:
        ...
        # print "inside Pwin:",(p, me, you, pending)
...
def max_wins(state):
    """
        The optimal pig strategy chooses an action with the highest win
    probability.
    """
...
print(Pwin((0, 37, 39, 1)))
# print Pwin((0,7,13,19))
#print Pwin((1,7,13,19))
#print len(Pwin.c)